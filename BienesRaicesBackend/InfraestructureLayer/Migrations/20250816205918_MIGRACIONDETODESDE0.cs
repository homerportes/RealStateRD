...
{
    /// <inheritdoc />
    public partial class MIGRACIONDETODESDE0 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shifts_Configurations_ConfigurationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSlots_Configurations_ConfigurationId",
                        column: x => x.ConfigurationId,
                        principalTable: "Configurations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeSlots_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shifts_ConfigurationId",
                table: "Shifts",
                column: "ConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_ConfigurationId",
                table: "TimeSlots",
                column: "ConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_ShiftId",
                table: "TimeSlots",
                column: "ShiftId");
